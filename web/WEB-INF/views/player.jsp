...
<script>
    ...
    const play = document.querySelector(".icon-player-play");
    const progressDiv = document.querySelector(".xyy-player-video-footer-progress");
    ...
    function timeupdate() {
        let playStartTime = document.getElementById("playStartTime");
    ...
    function loadedmetadata() {
        let playEndTime = document.getElementById("playEndTime");
